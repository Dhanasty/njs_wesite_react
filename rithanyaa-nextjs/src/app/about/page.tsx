      ...
      <section className="relative py-32 bg-gradient-to-r from-primary-800 to-primary-600 text-white">
        ...
        <div className="relative z-10 container-custom text-center">
          ...
          <p className="text-xl lg:text-2xl mb-8 max-w-3xl mx-auto">
            Celebrating Indias rich textile heritage through premium silk sarees that blend traditional craftsmanship with contemporary elegance
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-neutral-600 mb-6 leading-relaxed">
                ...
                Indias magnificent textile traditions. What started as a small family business has 
      ...
      <section className="section-padding bg-gradient-to-r from-primary-700 to-primary-600 text-white">
        <div className="container-custom text-center">
          ...
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Discover our exquisite collections and be part of preserving Indias textile heritage
          </p>
